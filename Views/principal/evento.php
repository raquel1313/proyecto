        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="<?php echo $data ['evento'] ['enlace_eve'];?>" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $data ['evento'] ['desc_eve'];?></h1>
                            <p class="h3 py-2"><?php echo  $data ['evento'] ['fecha_eve'];?></p>
                            
                            

                            <h6>Descripción:</h6>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium autem at veritatis, tenetur accusamus et cumque ipsa blanditiis, temporibus modi quos aperiam delectus quia doloribus optio natus qui voluptas rem!</p>
                            <p class="py-2">
